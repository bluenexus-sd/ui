<script context="module">
	export async function load({ url: { path }, session }) {
...
<div class="min-h-screen" dir={$storeLocale === 'ar' ? 'rtl' : 'ltr'}>
	<div class="relative overflow-hidden">
		<header class="relative">
			<div class="bg-kabdi-secondary py-6">
				<nav
						...
						<div class="px-5 pt-4 flex items-center justify-between">
							...
							<div class="-mr-2">
								<button
									...
									type="button"
									class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-sky-600"
								>
